...
import 'package:malikopal/bloc/dashboard_bloc.dart';
...
class ListBuilder extends StatelessWidget {
            ...
            child: Column(
              children: [
                CapitalPaymentHistoryCard(
                  ...
                  icon: CircleAvatar(
                    radius: 20.h,
                    backgroundColor: ((data[index].type == "Rollover" ? Color(0xFFF6921E) 
  : (data[index].credit ?? 0) > 0 ? Color(0xff254180) : Color(0xFFF6921E))),
  ...
  : (data[index].type == "Rollover"
      ? SvgPicture.asset('assets/svg/rollover.svg', width: 18.h, height: 18.h)
      : (data[index].credit! > 0
          ? SvgPicture.asset('assets/svg/down_arrow.svg', width: 18.h, height: 18.h)
